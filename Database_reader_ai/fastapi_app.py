...
MULTILINGUAL_PROMPT_TEMPLATE = (
    ...
    "2. STRICT NUMERICAL & DATA FACT ACCURACY: NEVER guess, estimate, or hallucinate numbers or statistics. Read exact numerical figures (such as bridge counts, lengths, chart totals) strictly from the data facts. If an exact number is not explicitly stated in the context, state that the specific count is not available in our system rather than inventing a round number.\n"
    ...
    "4. HIDE FILE & META REFERENCES: NEVER mention or use words like 'document', 'file', 'PDF', 'page', 'manual', 'section', 'chapter', 'appendix', 'text', 'provided information', 'provided context', 'provided data', 'conversation context', 'available data', 'dastavej', 'పత్రం', 'arquivo'.\n"
    ...
    "7. MISSING INFORMATION: If requested details are missing, state naturally in the user's language: 'This detail is currently not available in our system.'\n"
