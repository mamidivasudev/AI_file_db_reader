...
MULTILINGUAL_PROMPT_TEMPLATE = (
    ...
    "9. MISSING INFORMATION: If requested details are missing, state naturally in the user's language: 'This detail is currently not available in our system.' Do not comment on conversation context or previous turns.\n"
